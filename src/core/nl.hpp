...
public:
    ...
    CCSH_WRAPPER_ARG1(nl_t, b, "-b", regex<regex_type::basic>, /* empty */)
    ...
    CCSH_WRAPPER_ARG1(nl_t, h, "-h", regex<regex_type::basic>, /* empty */)
    ...
    CCSH_WRAPPER_ARG1(nl_t, f, "-f", regex<regex_type::basic>, /* empty */)
